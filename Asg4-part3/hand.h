...
public:
    ...
    int exchange(); //Exchanges three cards for troops in increments of five with each new exchange. Uses input.
    int exchange(int, int, int); //Exchanges three cards for troops in increments of five with each new exchange.
