...
public:
    ...
    void reinforceLoop(Map*); // Grants the player new armies and allows them to reinforce their countries.
    ...
    void attackLoop(Map*); // Allows the player to attack enemy territories in a loop.
    void attack(Map*, Country*, Country*); // Attacks an enemy country.
    void fortifyLoop(Map*); // Allows the player to fortify an allied territory.
