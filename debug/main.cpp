...
int main()
{
    ...
    vector<Player> p;
    Player p1("Fred", new CheaterStrategy(), &d);
    Player p2("Bob", new AggressiveStrategy(), &d);
    Player p3("Joe", new BenevolentStrategy(), &d);
    Player p4("John", new BenevolentStrategy(), &d);
    p.push_back(p1);
    p.push_back(p2);
    p.push_back(p3);
    p.push_back(p4);
